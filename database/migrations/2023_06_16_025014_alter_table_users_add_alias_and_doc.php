...
class AlterTableUsersAddAliasAndDoc extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        SELECT u.id, u.name, u.alias, u.email, mr.role_id, r.name as type, o.alias_name as subordination
        FROM users as u
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropColumn(['alias', 'document_person']);
        });
