            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 5], 'Nome', 'Sistema', 'Plataforma', 'Status', 'Autor', 'Visualizações', 'Palavras chaves', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'order' => [0, 'desc'],
                                'ajax' => url('/admin/reports'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'system', 'name' => 'system'], ['data' => 'platform', 'name' => 'platform'], ['data' => 'status', 'name' => 'status'], ['data' => 'author', 'name' => 'author'], ['data' => 'views', 'name' => 'views'], ['data' => 'keys', 'name' => 'keys'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
